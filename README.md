...
Van már 300 view a repon, nem tudom kik vagytok, de puszi a pocitokra
...
`.\wpf` =>>> WPF Frontend kód részletek

`.\c#` =>>> C# Console Application kód részletek

`.\asp.NET` =>>> asp.NET WebAPI kód részletek

# 📚 Technikusi Vizsga - Gyakorlati Teszt 

Ez itt egy összefoglaló a Technikusi vizsgának a gyakorlati részéhez. Nyugodtan osszátok tovább másoknak, viszont arra figyeljetek hogy folyamatosan frissülni fog újabb és újabb információkkal!
